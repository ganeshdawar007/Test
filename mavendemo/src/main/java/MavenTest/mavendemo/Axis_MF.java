...
//import pack.Monitoring_FrameWork;
...
public class Axis_MF {
	...
	public static void test() throws Exception
	{
		...
		Monitoring_FrameWork.CreatePath("Axis_MF", "/home/apmo8/Desktop", "10");
      ...
      // DesiredCapabilities cap=new DesiredCapabilities();
		...
		try
		{
			...
			//((JavascriptExecutor)driver).executeScript("document.body.style.zoom='0.25';");
			...
			//html.sendKeys(Keys.chord(Keys.CONTROL, "10"));
		...
		try
		{
			...
			WebElement investwus=driver.findElement(By.xpath("//*[@id='dropdownInvestmenu']/ul/li[1]/a/div[2]"));
			executor.executeScript("arguments[0].click();", investwus);
		...
		{
			Monitoring_FrameWork.SaveResult(starttime, "Login Page", status, maxwait, availability_alert, ResponseTime_alert,driver);
		}
		/*try
		{
			starttime=0;		
	...
	//driver.findElement(By.id("txtUserName")).sendKeys("aniruddhupadhyay@gmail.com");//DONT USE THIS ID (ID N PWD CHANGED)
		...
		//driver.findElement(By.id("txtPassword")).sendKeys("");
	     driver.findElement(By.id("txtPassword")).sendKeys("chase@123");//("chase@123")//sat@1903
			...
			//String captcha=Captcha.reCap(driver).trim();JOptionPane.showInputDialog(frame,"Enter CAPTCHA");
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("html/body/form/div[3]/div[8]/div/div[1]/div[7]/div[1]/div[3]/div/div/div[1]/div[2]/a")));
			if(driver.findElement(By.xpath("html/body/form/div[3]/div[8]/div/div[1]/div[7]/div[1]/div[3]/div/div/div[1]/div[2]/a")).isDisplayed())
			{
				status=1;
			}
			else
		...
		finally
		{
			...
			Monitoring_FrameWork.SaveResult(starttime, "After Login Page", status, maxwait, availability_alert, ResponseTime_alert,driver);
		}
		...
		try
		{
			status=0;
			starttime=Monitoring_FrameWork.StartTime();
			//driver.findElement(By.xpath("html/body/form/div[3]/div[8]/div/div[1]/div[7]/div[1]/div[3]/div/div/div[1]/div[2]/a")).click();
			WebElement ele=driver.findElement(By.xpath("html/body/form/div[3]/div[8]/div/div[1]/div[7]/div[1]/div[3]/div/div/div[1]/div[2]/a"));
		...
		{
			Monitoring_FrameWork.SaveResult(starttime, "Folio & Distributor Details Page", status, maxwait, availability_alert, ResponseTime_alert,driver);
		}
		try
		{	
			status=0;
			...
			starttime=Monitoring_FrameWork.StartTime();
			WebElement elemnt= driver.findElement(By.xpath("//*[@id='div_Step1_Folio_Broker_Details']/a"));
			//*[@id="div_Direct"]/a/img
		...
		{
			Monitoring_FrameWork.SaveResult(starttime, "Scheme Details Page", status, maxwait, availability_alert, ResponseTime_alert,driver);
		}
...
try
{
	...
	{
		Monitoring_FrameWork.SaveResult(starttime, "Mutual Fund Result Page", status, maxwait, availability_alert, ResponseTime_alert,driver);
	}
		...
		//	Thread.sleep(1000);
			...
			starttime=Monitoring_FrameWork.StartTime();
			WebElement ele=driver.findElement(By.linkText("Invest"));
			executor.executeScript("arguments[0].click();", ele);
		...
		{
			Monitoring_FrameWork.SaveResult(starttime, "Select Payment Option Page", status, maxwait, availability_alert, ResponseTime_alert,driver);
		}
...
//			robot.keyRelease(KeyEvent.VK_ENTER);
		...
		{
			Monitoring_FrameWork.SaveResult(starttime, "Payment Gateway Page", status, maxwait, availability_alert, ResponseTime_alert,driver);
			driver.quit();
		}
